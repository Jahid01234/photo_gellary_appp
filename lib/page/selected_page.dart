...
import 'package:photo_gellary_app/custom_design/bottom_container.dart';
import 'package:photo_gellary_app/custom_design/image_container.dart';
import 'package:photo_gellary_app/data/card_data.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(cards[index]["AlbumName"]!,style: GoogleFonts.poppins(color: Colors.white)),
        centerTitle: true,
        actions: [
          PopupMenuButton(
            itemBuilder: (context) => [],
